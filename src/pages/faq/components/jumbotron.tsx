...
const Jumbotron = () => {
  return (
    <StyledBox bg="#F9FAFB" p={8} rounded="md" textAlign="center">
      <HStack
        justify="center"
        mb={4}
        position="relative"
      ...
      >
        ...
        <Image src={a2} position="absolute" right="50px" top="-38px" zIndex={3} />
...
const StyledBox = styled(Box)`
  ...
  border-image: linear-gradient(to top, #000 28.27%, rgba(0, 0, 0, 0.1) 100%) 1;
`;
